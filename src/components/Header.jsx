...
const Header = () => {
  return (
    <nav class="block w-full max-w-screen px-6 py-3 mx-auto text-white bg-white border shadow-md  border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
